                ...
                try{
                    ...
                    for (int i=0; i<main.clientesA.size() ; i++) {
                        if (main.clientesA.get(i).getId() == Integer.parseInt(Menu.idCliente)){
                            textologA="\n"+dtf.format(LocalDateTime.now())+"\t"+main.username+": Ha visto al cliente \""+main.clientesA.get(i).getName()+"\" con id: "+Menu.idCliente+".";
